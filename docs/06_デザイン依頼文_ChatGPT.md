...
> 公式キャラクター `character-official.png` をご支給いただき済みです（ピンク1色〈C0 M65 Y0 K4／画面では #E87DAD〉のシルエット型マスコット／もこもことした輪郭・白い三日月形の目／下部にタグライン「ポイントは、愛。」）。**新規の生成は行いません。**
>
...
・元画像と同じピンク（#E87DAD）の1色ベタ塗り、輪郭線なし、フラット
